...
public class PurchaseDetailsService {
    ...
    public PurchaseDetailsModel updateDetails(PurchaseDetailsModel request, Long id){
        PurchaseDetailsModel details = purchaseDetailsRepository.findById(id)
                .orElseThrow(() -> new com.api.manager.exception.ResourceNotFoundException("Purchase detail not found with id " + id));
        ...
        return purchaseDetailsRepository.save(details);
    }
